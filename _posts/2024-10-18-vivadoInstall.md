...
3. 下载Windows环境下的在线安装器（Windows Self Extracting Web Installer）
   ...
   ![download](./picture/vivadoInstall/download.jpg)
...
3. 点击“Next”。
   ...
   ![continue](./picture/vivadoInstall/continue.jpg)

4. 登录下载时注册的AMD账号，点击“Next”。

   ![login](./picture/vivadoInstall/login.jpg)
5. 选择“vivado”，点击“Next”。

   ![product](./picture/vivadoInstall/product.jpg)

6. 选择免费的标准版，点击“Next”。

   ![edition](./picture/vivadoInstall/edition.jpg)

7. 在“Device”中必勾选“Artix-7”，因为开发板搭载的FPGA是Artix-7，其他器件可以根据需要进行选择，“Design Tools”和“Installation Options”按照默认即可。

   ![device](./picture/vivadoInstall/device.jpg)

8. 全部“I agree”，点击“Next”。

   ![agree](./picture/vivadoInstall/agree.jpg)

9. 选择Vivado安装目录，默认安装在“C:\Xilinx”下，可以点击浏览或者直接更改路径，注意**安装路径中不能出现中文和空格**。点击“Next”。

   ![directory](./picture/vivadoInstall/directory.jpg)
